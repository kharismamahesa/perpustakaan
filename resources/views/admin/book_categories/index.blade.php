    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <button id="btn-tambah-user" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data</button>
            </div>
        </div>
        <div class="card-body">
...
@push('scripts')
    ...
    <script>
        ...
        $(function() {
            const table = $('#book-categories-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('book-categories.data') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
